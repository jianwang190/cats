...
Poniższe grafy zostały stworzone przy pomocy biblioteki JavaScript, D3.js. Wierzchołki oznaczają kursy (przedmioty) zaś krawędzie w grafie konflikty pomiędzy kursami (uwzględniając tego samego prowadzącego bądź należenie do tego samego programu nauczania). 
