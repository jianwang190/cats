...
Jako, że każdy z algorytmów charakteryzuje się innym podejściem do problemu, dlatego też przedstawimy ogólną ideę każdego z tych algorytmów oraz opiszemy wybrane przez nas rozwiązanie. 
