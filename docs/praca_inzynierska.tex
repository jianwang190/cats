...
\paragraph{Proste sąsiedztwo} Ruch zdefiniowany jest jako zamiana przypisanego okresu i sali między dwoma zajęciami z różnych kursów. Specjalnym przypadkiem tego ruchu jest przeniesienie zajęcia na jedną z pustych pozycji. 
\paragraph{Sąsiedztwo rozszerzone - łańcuchy Kempe}
